...
<input type="checkbox" name="rek"/>
 ...
 <a href="regulamin.php" style="{text-decoration:none;font-color:white;}" > Regulamin <a/> <input type="submit" id="left" value="Wyslij"/>
...
echo "</br>";
 ...
 <form action="zaloguj.php" method="POST" >
  <input type="submit" value="Powrót do zaloguj"/>
