...
<form method="post" action="skryptwywiadowek.php">
	...
	<input type="date" name="data"style="height:25px;border-radius:4px;">
	<input type="number" name="sala" style="height:25px;border-radius:4px;" placeholder="sala" value="">
