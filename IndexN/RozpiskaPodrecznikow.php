...
<div style="float:left;background-color:;min-width:30%;min-height:30px;font-size:15px;text-align:center;"> Lekcja </div>
<div style="float:left;background-color:;width:30%;min-height:30px;font-size:15px;text-align:center;"> Nazwa podręcznika </div>
<div style="float:left;background-color:;min-width:30%;min-height:30px;font-size:15px;text-align:center;"> Nazwa ćwiczeń </div>
...
<form method="POST" action="SkryptRozpiskaPodrecznikow.php">
	<div style="float:left;width:30%;min-height:40px;border:1px dotted black;font-size:18px;text-align:center;" id="login"> <?php   echo $lekcjaaa;?> </div>
	<div style="float:left;width:30%;min-height:40px;border:1px dotted black;font-size:18px;text-align:center;" id="login"> <input name="pdr" class="enjoy-css" placeholder="<?php  $pom="NazwaPodrecznika"; require"PlaceholderdPodreczniki.php" ?>"/> </div>
	<div style="float:left;width:30%;min-height:40px;border:1px dotted black;font-size:18px;text-align:center;" id="klasa"> <input name="czw" class="enjoy-css" placeholder="<?php  $pom="NazwaCzwiczen"; require"PlaceholderdPodreczniki.php" ?>"/> </div>
	<div style="clear:both" id="clear"> </div>
