...
<form method="post" action="skryptwywiadowek3.php">
	<select style="width:120px;height:30px;border-radius:400px;" name='sele'>
		<?php
		include "baza.php";
		if ($result = $wynik->query("SELECT * FROM wywiadowka WHERE aktywna='0'"))
		{
	...
	<input type='submit' style="height:25px;border-radius:400px;"value="Aktywuj wywiadówkę">
</form>
