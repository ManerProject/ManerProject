<ol style=" list-style-type:none;padding:0;margin:0;">
	...
	?>
	<li id="c<?php echo $s['numer_lekcji'] ?>"style="background-color:
		<?php 
		...
		?>
		; display:block;width:35px;height:35px;float:left;font-size:33px;border:2px white solid;border-radius:5px;">
		<?php  if($s['obecnosc']==1)echo "0";
